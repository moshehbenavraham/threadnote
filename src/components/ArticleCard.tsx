...
const ArticleCard = ({
  ...
  // Crawlers and assistive tech parse the `dateTime` attribute, not the
  // visible string — derive an ISO value from `date` whenever an explicit
  // `publishedAt` isn't supplied so the markup is never empty.
      ...
      >
        ...
        <div className="p-5 md:p-6 flex flex-col flex-1">
          <time
            ...
            className="text-sm font-medium text-foreground/70 mb-3 block font-sans"
          >
            {date}
          </time>
